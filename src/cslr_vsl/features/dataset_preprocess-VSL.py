...
if __name__ == '__main__':
    ...
    parser.add_argument('--scripts', type=str, default='VSL',
                        help='save prefix')
    parser.add_argument('--scripts-root', type=str, default='/home/martinvalentine/Desktop/CSLR-VSL/data/interim/VSL_Benchmark',
                        help='path to the scripts')
    parser.add_argument('--annotation-prefix', type=str, default='/home/martinvalentine/Desktop/CSLR-VSL/data/processed/VSL_Benchmark/csv/{}_annotations.csv',
