...
class Preprocessing:
     ...
     def resize_dataset(video_idx, dsize, info_dict):
          ...
          prefix = '/home/martinvalentine/Desktop/CSLR-VSL/data/interim/VSL_Sample'
          img_list = glob.glob(f"{prefix}/{info['folder']}")
          for img_path in img_list:
               rs_img = resize_img(img_path, dsize=dsize)
               rs_img_path = img_path.replace("interim/VSL_Sample", "processed/VSL_Sample/features/" + dsize)
