...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000):
        ...
        # Adjusted for 1080x1080 input
        self.conv1 = nn.Conv3d(3, 64, kernel_size=(1, 11, 11), stride=(1, 4, 4), padding=(0, 5, 5), bias=False)
        self.bn1 = nn.BatchNorm3d(64)
        self.relu = nn.ReLU(inplace=True)
        self.maxpool = nn.MaxPool3d(kernel_size=(1, 5, 5), stride=(1, 3, 3), padding=(0, 2, 2))
